...
class EcomMixin(object):
    def dispatch(self, request, *args, **kwargs):
        ...
        if cart_id:
            count = Cart.objects.filter(id=cart_id).count()
            if request.user.is_authenticated and count > 0 :
...
class HomeView(EcomMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['myname'] = "Urvashi Patidar"
...
class CheckoutView(EcomMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            Customer_obj = self.request.user.customer
            Cart.objects.filter(id=cart_id).update(customer=Customer_obj) 
            ...
            if pm == "khalti":
                ...
                return redirect(reverse("ecomapp:esewarequest") + "?o_id=" + str(order.id)) 
                  ...
                  ########### after checkout connection is to set there     
        else:
...
class CustomerLoginView(FormView):
    ...
    # form_vaild method is a type of post method and is available in createview formview and updateview
    def form_valid(self, form):
